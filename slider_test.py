...
<div class="legal-disclaimer">
    <p>Los valores mostrados son aproximados y de carácter informativo. El incumplimiento en los pagos puede generar intereses moratorios y gastos adicionales. Aplica condiciones y está sujeto a estudio de crédito.</p>
</div>
""", unsafe_allow_html=True)
